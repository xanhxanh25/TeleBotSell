...
- `ADMIN_PASSWORD_HASH`: SHA256 hash của password admin (mặc định: ``)
...
nssm set AdminWeb AppDirectory "AdminWeb"
nssm set AdminWeb AppStdout "\AdminWeb\logs\service.log"
nssm set AdminWeb AppStderr "\AdminWeb\logs\service_error.log"
