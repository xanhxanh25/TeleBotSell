...
var currencies = HomeController.GetActiveCurrency(EVMChains, Configuration);
...
// Web3 RPC watcher cho các chain có UseRpc=true (BSC — miễn phí, không cần API key trả phí)
Services.AddHostedService<OrderCheckBSCWeb3Service>();
// Binance Exchange deposit watcher (bật qua Binance:Enable trong appsettings)
Services.AddHostedService<OrderCheckBinanceService>();
