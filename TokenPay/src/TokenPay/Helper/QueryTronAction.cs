...
namespace TokenPay.Helper
{
    public static partial class QueryTronAction
    {
        ...
        public static async Task<decimal> GetUsdtAmountAsync(string Address)
        {
            ...
            var encoded = new FunctionCallEncoder().EncodeParameters(
                new Parameter[] { new Parameter("address", "who") },
            ...
            {
                Log.Logger.Information("Kiểm tra số dư: {address}", Address);
                // Log.Logger.Information("Dữ liệu: {@result}", result);
        ...
        public static async Task<(bool, string?)> TransferTrxAsync(this TronWallet wallet0, decimal value, string ToAddress)
        {
            ...
            var request1 = BaseUrl.WithTimeout(5);
            var request2 = BaseUrl.WithTimeout(5);
            var request3 = BaseUrl.WithTimeout(5);
            ...
            var result2Data = request2
                .AppendPathSegment("wallet/broadcasttransaction")
                .PostJsonAsync(req);
            ...
            if (result2.Result)
            {
                ...
                if (result3.RawData == null)
                {
                    ...
                    while (result3.RawData == null && count < 10)
                    {
                        ...
                        Log.Logger.Information("Đang chờ giao dịch được ghi lên chain, TXID={a}", result2.Txid);
            ...
            return (result2.Result, result2.Result ? result2.Txid : "Broadcast thất bại!");
        }
        ...
        public static async Task<(bool, string?)> TransferUSDTAsync(this TronWallet wallet0, decimal value, string ToAddress)
        {
            ...
            var encoded = new FunctionCallEncoder().EncodeParameters(
                new Parameter[] { new Parameter("address", "_to"), new Parameter("uint256", "_value") },
        ...
        /// <summary>
        /// Lấy thông tin tài nguyên (resource) của tài khoản
        /// </summary>
        ...
        /// <summary>
        /// Lấy dữ liệu giao dịch TRX thô (raw) đã ký, trả về dạng JObject
        /// </summary>
        public static async Task<(bool, string?, JObject?)> GetTransferTrxSignedTxnToJobjectAsync(
            string OwnerAddress,
            string privateKey,
            decimal value,
            string ToAddress
        ...
        {
            var BaseUrl = configuration.GetValue("TronApiHost", "https://api.trongrid.io");
            var request = BaseUrl.WithTimeout(5);
